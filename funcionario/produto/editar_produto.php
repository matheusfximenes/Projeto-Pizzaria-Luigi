            ...
            <div class="col-md-12">
            	<table class="table">
                  ...
                  foreach( $consultas as $consulta){
            				...
            				print "<td><input type='text' name='descricao' value='$consulta[descricao]'/> </td>";
            				print "<td><input type='text' name='preco' value='$consulta[preco]'/> </td>";
                    print "<td><input type='text' name='tamanho' value='$consulta[tamanho]'/> </td>";
