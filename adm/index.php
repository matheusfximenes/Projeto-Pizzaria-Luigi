  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="../info/contato.php">Contato</a></li>
            <li class="dropdown">
    ...
    <div class="container">
        ...
        <div class="row">
              ...
              <!--Funcionario-->
              <div class="col-xs-6 col-md-3">
                <a href="funcionario/funcionario.php" class="thumbnail">
                <h5>Gerenciar Funcionario</h5>
                  <img src="img/cliente.png" alt="Funcionario" >
                </a>
              </div>
