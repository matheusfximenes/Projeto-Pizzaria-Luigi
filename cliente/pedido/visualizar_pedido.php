              ...
              <div class="col-md-12">
                  <table class="table table-hover">
                    <thead>
                      ...
                      <th style="background-color:#CCEEFF;">Editar</th>
                    ...
                    <tbody>
                      <?php
                        ...
                        $con = new conecta();
                        $sql = "SELECT id,cliente, produto, quantidade, total, situacao FROM pedidosd";
                        ...
                        foreach ($consultas as $consulta) {
                           print"<td>$consulta[id]</td>";
                            ...
                            print"<td><a href='editar_pedido.php?id=$consulta[id]' class='btn btn-danger'>Editar</a></td>";
                            print "</tbody>";
                        }
                      ?>
