...
<html lang="pt-br">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="../home.php">Tela Inicial</a></li>
    ...
    <footer class="footer">
      <div class="container">
        <br><h2>Tipos de contatos</h2>
        <br><h4></h4>
      </div>
      <div class="container">
        <hr>
        <p class="text-muted">
          <center>Telefones :(88)99999999/(85)999999999(whatsapp) </br></center>
          <center>Instagram: @pizzaluigi </br></center>
          <center>Email : email@gmail.com </br></center>
